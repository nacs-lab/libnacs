...
NACS_FEATURE_DEF(sve2, 32 + 1, 0) // HWCAP2_SVE2
// NACS_FEATURE_DEF_NAME(sve2_aes, 32 + 2, 0, "sve2-aes") // HWCAP2_SVEAES, Implied by `sve2-aes`
NACS_FEATURE_DEF_NAME(sve2_aes, 32 + 3, 0, "sve2-aes") // HWCAP2_SVEPMULL, ID_AA64ZFR0_EL1.AES == 2
NACS_FEATURE_DEF_NAME(sve2_bitperm, 32 + 4, 0, "sve2-bitperm") // HWCAP2_SVEBITPERM
NACS_FEATURE_DEF_NAME(sve2_sha3, 32 + 5, 0, "sve2-sha3") // HWCAP2_SVESHA3
NACS_FEATURE_DEF_NAME(sve2_sm4, 32 + 6, 0, "sve2-sm4") // HWCAP2_SM4
