...
static constexpr CPUSpec cpus[] = {
    ...
    {"neoverse-n1", CPU::arm_neoverse_n1, CPU::generic, 0, Feature::arm_neoverse_n1},
...
static constexpr CPUSpec cpus[] = {
    ...
    {"cortex-a55", CPU::arm_cortex_a55, CPU::generic, 0, Feature::arm_cortex_a55},
    {"cortex-a57", CPU::arm_cortex_a57, CPU::generic, 0, Feature::arm_cortex_a57},
    {"cortex-a65", CPU::arm_cortex_a65, CPU::generic, 0, Feature::arm_cortex_a65},
    {"cortex-a65ae", CPU::arm_cortex_a65ae, CPU::generic, 0, Feature::arm_cortex_a65},
    {"cortex-a72", CPU::arm_cortex_a72, CPU::generic, 0, Feature::arm_cortex_a72},
    {"cortex-a73", CPU::arm_cortex_a73, CPU::generic, 0, Feature::arm_cortex_a73},
    {"cortex-a75", CPU::arm_cortex_a75, CPU::generic, 0, Feature::arm_cortex_a75},
    {"cortex-a76", CPU::arm_cortex_a76, CPU::generic, 0, Feature::arm_cortex_a76},
    ...
    {"cortex-a77", CPU::arm_cortex_a77, CPU::arm_cortex_a76, UINT32_MAX, Feature::arm_cortex_a77},
    {"cortex-a78", CPU::arm_cortex_a78, CPU::arm_cortex_a77, UINT32_MAX, Feature::arm_cortex_a78},
    {"neoverse-e1", CPU::arm_neoverse_e1, CPU::generic, 0, Feature::arm_neoverse_e1},
    {"neoverse-n1", CPU::arm_neoverse_n1, CPU::generic, 0, Feature::arm_neoverse_n1},
    ...
    {"exynos-m5", CPU::samsung_exynos_m5, CPU::samsung_exynos_m4, 110000,
     Feature::samsung_exynos_m5},
    {"apple-a7", CPU::apple_a7, CPU::generic, 0, Feature::apple_a7},
    {"apple-a8", CPU::apple_a8, CPU::generic, 0, Feature::apple_a7},
    {"apple-a9", CPU::apple_a9, CPU::generic, 0, Feature::apple_a7},
    {"apple-a10", CPU::apple_a10, CPU::generic, 0, Feature::apple_a10},
    {"apple-a11", CPU::apple_a11, CPU::generic, 0, Feature::apple_a11},
    {"apple-a12", CPU::apple_a12, CPU::generic, 0, Feature::apple_a12},
    {"apple-a13", CPU::apple_a13, CPU::generic, 0, Feature::apple_a13},
    ...
    {"apple-s4", CPU::apple_s4, CPU::generic, 0, Feature::apple_s4},
    {"apple-s5", CPU::apple_s5, CPU::generic, 0, Feature::apple_s5},
