...
TEST_CASE("Convert") {
    ...
    }
    {
        ...
        test_str_eq(builder.get(),
                    ...
                    "  ret Float64 %0\n"
                    "}");
        TestCodegen<bool(double)>([] (double v) {
            return v != 0;
    ...
    }
    {
        ...
        test_str_eq(builder.get(),
                    ...
                    "  ret Float64 %0\n"
                    "}");
        TestCodegen<int(double)>([] (double v) {
            return (int)v;
    ...
    }
    {
        ...
        test_str_eq(builder.get(),
                    ...
                    "  ret Bool %0\n"
                    "}");
        TestCodegen<double(bool)>([] (bool v) {
            return v ? 1 : 0;
        }, {false, true}, ctx, builder.get());
    }
    {
