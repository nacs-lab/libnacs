...
static void test_default_empty()
{
    ...
    host_seq.init();
    assert(host_seq.global_ages().size() == 0);
    ...
    for (uint32_t i = 0; i < 3; i++) {
        ...
        assert(host_seq.seqs[0].length == 0);

        assert(host_seq.start_values[0].f64 == 1.2);
        assert(host_seq.start_values[1].f64 == 3.4);

        assert(host_seq.values[0].f64 == 1.2);
        assert(host_seq.values[1].f64 == 3.4);
        assert(host_seq.post_run() == 0);
        assert(host_seq.cur_seq_idx() == uint32_t(-1));
    }
}

static void test_increment_loop()
{
    ...
    for (uint32_t i = 0; i < 3; i++) {
        ...
        for (int j = 0; ; j++) {
            ...
            assert(host_seq.start_values[0].f64 == v1);
            assert(host_seq.start_values[1].f64 == v2);
            assert(host_seq.first_bseq == (j == 0));
            assert(host_seq.cur_seq_idx() == 0);
            ...
            // Assigned globals
            assert(host_seq.values[1].f64 == v1);
            assert(host_seq.values[2].f64 == v2);
            // Channel final values
            assert(host_seq.values[4].f64 == v1);
            assert(host_seq.values[5].f64 == v2);
            // Pulse values
            assert(host_seq.values[6].f64 == v1);
            assert(host_seq.values[7].f64 == v2);

            auto &host_bseq = host_seq.seqs[0];
            assert(host_bseq.pulses[0].id == 1);
            assert(host_bseq.pulses[0].chn == 1);
            assert(host_bseq.pulses[0].endvalue == v1);
            assert(host_bseq.pulses[1].id == 2);
            assert(host_bseq.pulses[1].chn == 2);
            assert(host_bseq.pulses[1].endvalue == v2);

            assert(host_bseq.length == 125);
            ...
            bool cond = v1 <= v2;
            assert(host_seq.post_run() == (cond ? 1 : 0));
            assert(host_seq.values[3].b == cond);
...
static void test_increment_loop_t0()
{
    // Ch1: increase by 0.2 per cycle
    // Ch2: decrease by 0.3 per cycle
    // Branch condition: stop when Ch1 > Ch2
...
static void test_global()
{
...

    {
        ...
        host_bseq.pulses[0] = Seq::HostSeq::Pulse{
            .id = 1, .time = 0, .measure = uint32_t(-1), .len = uint32_t(-1),
            .value = 9, .chn = 1, .ramp_func = nullptr
        };
    ...
    assert(host_seq.values[1].f64 == 0);
    assert(host_seq.values[2].f64 == 0);
    assert(host_seq.values[3].f64 == 0);
    assert(host_seq.get_global(0) == 0);
    assert(host_seq.get_global(1) == 0);
    assert(host_seq.get_global(2) == 0);
    ...
    assert(host_seq.values[1].f64 == 3.4);
    assert(host_seq.values[2].f64 == 5.6);
    assert(host_seq.values[3].f64 == 0);
    assert(host_seq.get_global(0) == 3.4);
    assert(host_seq.get_global(1) == 5.6);
    assert(host_seq.get_global(2) == 0);

    host_seq.values[3].f64 = 9.8;
    assert(host_seq.values[3].f64 == 9.8);
    assert(host_seq.get_global(2) == 0);
    ...
    assert(host_seq.values[0].i64 == 123);
    assert(host_seq.values[1].f64 == 3.4);
    assert(host_seq.values[2].f64 == 5.6);
    assert(approx(host_seq.values[3].f64, 5.3));
    assert(approx(host_seq.values[4].f64, 3.9)); // 3.4 + 0.5
    // assert(host_seq.values[5].f64 == 0); // Unused by BS1
    // assert(host_seq.values[6].b == false); // Unused by BS1
    // assert(host_seq.values[7].b == false); // Unused by BS1
    assert(approx(host_seq.values[8].f64, 5.3)); // 1.2 + 0.2 + 3.9
    assert(approx(host_seq.values[9].f64, 5.3));

    assert(host_bseq->pulses.size() == 1);
    assert(host_bseq->pulses[0].id == 1);
    assert(host_bseq->pulses[0].chn == 1);
    assert(approx(host_bseq->pulses[0].endvalue, 5.3));

    assert(host_seq.post_run() == 1);
    assert(host_seq.cur_seq_idx() == 0);
    ...
    assert(host_seq.values[2].f64 == 5.6);
    assert(approx(host_seq.values[3].f64, 5.3));
    assert(approx(host_seq.values[4].f64, 3.9));
    // assert(host_seq.values[5].f64 == 0); // Unused by BS1
    assert(host_seq.values[6].b == true);
    // assert(host_seq.values[7].b == false); // Unused by BS1
    assert(approx(host_seq.values[8].f64, 5.3));
    assert(approx(host_seq.values[9].f64, 5.3));
    ...
    assert(host_bseq->length == 123);
    assert(approx(host_seq.start_values[0].f64, 5.3));
    ...
    assert(host_seq.values[0].i64 == 123);
    assert(host_seq.values[1].f64 == -0.3);
    assert(host_seq.values[2].f64 == 5.6);
    assert(approx(host_seq.values[3].f64, 5.7));
    assert(approx(host_seq.values[4].f64, 0.2)); // -0.3 + 0.5
    // assert(host_seq.values[5].f64 == 0); // Unused by BS1
    assert(host_seq.values[6].b == true);
    // assert(host_seq.values[7].b == false); // Unused by BS1
    assert(approx(host_seq.values[8].f64, 5.7)); // 5.3 + 0.2 + 0.2
    assert(approx(host_seq.values[9].f64, 5.7));

    assert(host_bseq->pulses.size() == 1);
    assert(host_bseq->pulses[0].id == 1);
    assert(host_bseq->pulses[0].chn == 1);
    assert(approx(host_bseq->pulses[0].endvalue, 5.7));
    ...
    assert(host_seq.values[0].i64 == 123);
    assert(host_seq.values[1].f64 == -0.3);
    assert(host_seq.values[2].f64 == 5.9);
    assert(approx(host_seq.values[3].f64, 5.7));
    assert(approx(host_seq.values[4].f64, 0.2));
    // assert(host_seq.values[5].f64 == 0); // Unused by BS1
    assert(host_seq.values[6].b == true);
    // assert(host_seq.values[7].b == false); // Unused by BS1
    assert(approx(host_seq.values[8].f64, 5.7));
    assert(approx(host_seq.values[9].f64, 5.7));
    ...
    host_bseq = &host_seq.seqs[0];
    assert(host_bseq->length == 123);
    assert(approx(host_seq.start_values[0].f64, 5.7));
    ...
    assert(host_seq.values[1].f64 == -0.3);
    assert(host_seq.values[2].f64 == 5.9);
    assert(approx(host_seq.values[3].f64, 6.1));
    assert(approx(host_seq.values[4].f64, 0.2));
    // assert(host_seq.values[5].f64 == 0); // Unused by BS1
    assert(host_seq.values[6].b == true);
    // assert(host_seq.values[7].b == false); // Unused by BS1
    assert(approx(host_seq.values[8].f64, 6.1)); // 5.7 + 0.2 + 0.2
    assert(approx(host_seq.values[9].f64, 6.1));

    assert(host_bseq->pulses.size() == 1);
    assert(host_bseq->pulses[0].id == 1);
    assert(host_bseq->pulses[0].chn == 1);
    assert(approx(host_bseq->pulses[0].endvalue, 6.1));
    ...
    assert(host_seq.post_run() == 2);
    assert(host_seq.cur_seq_idx() == 1);
    ...
    assert(approx(host_seq.values[4].f64, 0.2));
    // assert(host_seq.values[5].f64 == 0); // Unused by BS1
    assert(host_seq.values[6].b == false);
    // assert(host_seq.values[7].b == false); // Unused by BS1
    assert(approx(host_seq.values[8].f64, 6.1));
    assert(approx(host_seq.values[9].f64, 6.1));
    ...
    assert(host_bseq->length == 123);
    assert(approx(host_seq.start_values[0].f64, 6.1));
    ...
    assert(host_seq.values[1].f64 == -0.3);
    assert(host_seq.values[2].f64 == 5.9);
    assert(approx(host_seq.values[3].f64, 3.9));
    assert(approx(host_seq.values[4].f64, 0.2));
    assert(approx(host_seq.values[5].f64, 5.6)); // 5.9 + -0.3
    assert(host_seq.values[6].b == false);
    // assert(host_seq.values[7].b == false); // Unused by BS2
    assert(approx(host_seq.values[8].f64, 3.9));
    assert(approx(host_seq.values[9].f64, 3.9)); // 6.1 + 3.4 - 5.6

    assert(host_bseq->pulses.size() == 1);
    assert(host_bseq->pulses[0].id == 2);
    assert(host_bseq->pulses[0].chn == 1);
    assert(approx(host_bseq->pulses[0].endvalue, 3.9));
    ...
    assert(host_seq.values[0].i64 == 123);
    assert(host_seq.values[1].f64 == 4.0);
    assert(host_seq.values[2].f64 == 5.9);
    assert(approx(host_seq.values[3].f64, 3.9));
    assert(approx(host_seq.values[4].f64, 0.2));
    assert(approx(host_seq.values[5].f64, 5.6));
    assert(host_seq.values[6].b == false);
    assert(host_seq.values[7].b == true);
    assert(approx(host_seq.values[8].f64, 3.9));
    assert(approx(host_seq.values[9].f64, 3.9));
    ...
    host_bseq = &host_seq.seqs[1];
    assert(host_bseq->length == 123);
    assert(approx(host_seq.start_values[0].f64, 3.9));
    ...
    assert(host_seq.values[1].f64 == 4.0);
    assert(host_seq.values[2].f64 == 5.9);
    assert(approx(host_seq.values[3].f64, -2.6));
    assert(approx(host_seq.values[4].f64, 0.2));
    assert(approx(host_seq.values[5].f64, 9.9)); // 5.9 + 4.0
    assert(host_seq.values[6].b == false);
    assert(host_seq.values[7].b == true);
    assert(approx(host_seq.values[8].f64, -2.6));
    assert(approx(host_seq.values[9].f64, -2.6)); // 3.9 + 3.4 - 9.9

    assert(host_bseq->pulses.size() == 1);
    assert(host_bseq->pulses[0].id == 2);
    assert(host_bseq->pulses[0].chn == 1);
    assert(approx(host_bseq->pulses[0].endvalue, -2.6));
    ...
    assert(host_seq.values[0].i64 == 123);
    assert(host_seq.values[1].f64 == -3.0);
    assert(host_seq.values[2].f64 == 5.9);
    assert(approx(host_seq.values[3].f64, -2.6));
    assert(approx(host_seq.values[4].f64, 0.2));
    assert(approx(host_seq.values[5].f64, 9.9));
    assert(host_seq.values[6].b == false);
    assert(host_seq.values[7].b == false);
    assert(approx(host_seq.values[8].f64, -2.6));
    assert(approx(host_seq.values[9].f64, -2.6));
    ...
    assert(host_seq.values[6].b == false);
    assert(host_seq.values[7].b == false);
    // Channel value resetted
    assert(approx(host_seq.values[8].f64, 1.2));
    assert(approx(host_seq.values[9].f64, -2.6));
    ...
    // Global variable values remains unchanged
    assert(host_seq.values[1].f64 == -3.0);
    assert(host_seq.values[2].f64 == -2.6);
    assert(approx(host_seq.values[3].f64, -2.6));
    assert(approx(host_seq.values[4].f64, 0.2));
    assert(approx(host_seq.values[5].f64, 9.9));
    assert(host_seq.values[6].b == false);
    ...
    assert(host_seq.values[1].f64 == -3.0);
    assert(host_seq.values[2].f64 == -2.6);
    assert(approx(host_seq.values[3].f64, -1.1));
    assert(approx(host_seq.values[4].f64, -2.5)); // -3.0 + 0.5
    assert(approx(host_seq.values[5].f64, 9.9));
    assert(host_seq.values[6].b == false);
    assert(host_seq.values[7].b == false);
    assert(approx(host_seq.values[8].f64, -1.1)); // 1.2 + 0.2 + -2.5
    assert(approx(host_seq.values[9].f64, -1.1));

    assert(host_bseq->pulses.size() == 1);
    assert(host_bseq->pulses[0].id == 1);
    assert(host_bseq->pulses[0].chn == 1);
    assert(approx(host_bseq->pulses[0].endvalue, -1.1));
    ...
    host_bseq = &host_seq.seqs[1];
    assert(host_bseq->length == 123);
    assert(approx(host_seq.start_values[0].f64, -1.1));
    ...
    assert(host_seq.values[1].f64 == -3.0);
    assert(host_seq.values[2].f64 == -2.6);
    assert(approx(host_seq.values[3].f64, 7.9));
    assert(approx(host_seq.values[4].f64, -2.5));
    assert(approx(host_seq.values[5].f64, -5.6)); // -3.0 + -2.6
    assert(host_seq.values[6].b == false);
    assert(host_seq.values[7].b == false);
    assert(approx(host_seq.values[8].f64, 7.9)); // -1.1 + 3.4 - -5.6
    assert(approx(host_seq.values[9].f64, 7.9));

    assert(host_bseq->pulses.size() == 1);
    assert(host_bseq->pulses[0].id == 2);
    assert(host_bseq->pulses[0].chn == 1);
    assert(approx(host_bseq->pulses[0].endvalue, 7.9));
    ...
    assert(ages[4] == 9);
    assert(ages[5] == 9);
    assert(ages[6] == 10); // Unchanged value but age should update
...
static void test_need_order_assign()
{
    ...
    assert(approx(host_seq.values[4].f64, 4.6));
    assert(host_seq.values[5].i64 == 0);
    assert(host_seq.values[6].i64 == 20);
    assert(host_seq.values[7].f64 == 1.2);
    assert(host_seq.values[8].f64 == 1.2);
    assert(approx(host_seq.values[9].f64, 4.6));
    ...
    host_seq.pre_run();
    host_bseq = &host_seq.seqs[0];
    assert(host_bseq->length == 46);
    assert(approx(host_seq.start_values[0].f64, 0.2));
    ...
    assert(host_seq.values[1].f64 == 1.2);
    assert(host_seq.values[2].f64 == 2.3);
    assert(host_seq.values[3].f64 == 25.6);
    assert(approx(host_seq.values[4].f64, 5.7));
    assert(host_seq.values[5].i64 == 26);
    assert(host_seq.values[6].i64 == 46);
    assert(host_seq.values[7].f64 == 2.3);
    assert(host_seq.values[8].f64 == 2.3);
    assert(approx(host_seq.values[9].f64, 5.7));

    assert(host_bseq->pulses.size() == 3);
    assert(host_bseq->pulses[0].id == 1);
    assert(host_bseq->pulses[0].chn == 1);
    assert(host_bseq->pulses[0].endvalue == 1.2);
    assert(host_bseq->pulses[1].id == 2);
    assert(host_bseq->pulses[1].chn == 1);
    assert(host_bseq->pulses[1].endvalue == 2.3);
    assert(host_bseq->pulses[2].id == 3); // measure
    assert(host_bseq->pulses[2].chn == 1);
    assert(host_bseq->pulses[2].len == uint32_t(-2));
...
static void test_measure_order_id()
{
    // Const:
    //   C0[V0]: time (20)
    //   C1[V1]: val 1 (1.2)
    ...
    auto host_bseq = &host_seq.seqs[0];
    assert(host_bseq->length == 20);
    assert(host_seq.start_values[0].f64 == 0.2);
    ...
    assert(host_seq.values[1].f64 == 1.2);
    assert(host_seq.values[2].f64 == 2.3);
    assert(host_seq.values[3].f64 == 1.2);
    assert(host_seq.values[4].f64 == 2.3);
    assert(host_seq.values[5].f64 == 1.2);

    assert(host_bseq->pulses.size() == 3);
    assert(host_bseq->pulses[0].id == 1);
    assert(host_bseq->pulses[0].chn == 1);
    assert(host_bseq->pulses[0].endvalue == 1.2);
    assert(host_bseq->pulses[1].id == 2); // measure
    assert(host_bseq->pulses[1].chn == 1);
    assert(host_bseq->pulses[1].len == uint32_t(-2));
    assert(host_bseq->pulses[2].id == 3);
    assert(host_bseq->pulses[2].chn == 1);
    assert(host_bseq->pulses[2].endvalue == 2.3);

    assert(host_seq.post_run() == 0);
    assert(host_seq.cur_seq_idx() == uint32_t(-1));
}

static void test_ramp_measure()
{
    // Test subjects:
    ...
    //     N5[V20]: MV5 * 2.8
    //   Pulse:
    //     P1(id=1): @C0 measure=MV0 ramp=[N0] MV0 + t * 0.001 len=1000
...

    {
        ...
        host_bseq.ndirect = 0;
        host_bseq.nneed_order = 6;

        host_bseq.types.resize(6); // ndirect + nneed_order
        host_bseq.types[0] = Seq::HostSeq::Type::Float64;
        host_bseq.types[1] = Seq::HostSeq::Type::Float64;
        ...
        host_bseq.evals.resize(6); // ndirect + nneed_order
        ...
        host_bseq.deps_count.resize(6); // nneed_order
        host_bseq.deps_count[0] = 1;
        ...
        host_bseq.pulses[1] = Seq::HostSeq::Pulse{
            ...
            .value = 16, .chn = 1, .ramp_func = nullptr
        };
        host_bseq.pulses[2] = Seq::HostSeq::Pulse{
        ...
        host_bseq.ndirect_assumes = 0;
        host_bseq.assumptions_idx.resize(6); // nneed_order
        host_bseq.assumptions_idx[0] = uint32_t(-1);
    ...
    host_seq.pre_run();
    assert(host_bseq->length == 6400);
    assert(approx(host_seq.start_values[0].f64, -0.4));
    ...
    // Consts
    assert(host_seq.values[0].i64 == 200);
    assert(host_seq.values[1].f64 == 1000);
    // Slots
    assert(host_seq.values[2].f64 == 100);
    assert(host_seq.values[3].f64 == 1300);
    assert(host_seq.values[4].f64 == 0);
    // Global Values
    assert(host_seq.values[5].i64 == 100);
    assert(host_seq.values[6].i64 == 1400);
    assert(host_seq.values[7].i64 == 6400);
    // Channels
    assert(approx(host_seq.values[8].f64, -12.9248));
    // Measures
    assert(approx(host_seq.values[9].f64, -0.52));
    assert(host_seq.values[10].f64 == -0.4);
    assert(approx(host_seq.values[11].f64, 0.48));
    assert(approx(host_seq.values[12].f64, 0.48));
    assert(approx(host_seq.values[13].f64, 1.084));
    assert(approx(host_seq.values[14].f64, -4.616));
    // Need Orders
    // V15 is a ramp
    assert(approx(host_seq.values[16].f64, -0.52));
    assert(approx(host_seq.values[17].f64, 1.084));
    assert(host_seq.values[18].i64 == 1956);
    assert(approx(host_seq.values[19].f64, -4.616));
    assert(approx(host_seq.values[20].f64, -12.9248));

    assert(host_bseq->pulses.size() == 6);
    assert(host_bseq->pulses[0].id == 2);
    assert(host_bseq->pulses[0].chn == 1);
    assert(approx(host_bseq->pulses[0].endvalue, -0.52));
    assert(host_bseq->pulses[1].id == 1);
    assert(host_bseq->pulses[1].chn == 1);
    assert(approx(host_bseq->pulses[1].endvalue, 0.48));
    assert(host_bseq->pulses[2].id == 3); // measure
    assert(host_bseq->pulses[2].chn == 1);
    assert(host_bseq->pulses[2].len == uint32_t(-2));
    assert(host_bseq->pulses[3].id == 4);
    assert(host_bseq->pulses[3].chn == 1);
    assert(approx(host_bseq->pulses[3].endvalue, 1.084));
    assert(host_bseq->pulses[4].id == 5);
    assert(host_bseq->pulses[4].chn == 1);
    assert(approx(host_bseq->pulses[4].endvalue, -4.616));
    assert(host_bseq->pulses[5].id == 6);
    assert(host_bseq->pulses[5].chn == 1);
    assert(approx(host_bseq->pulses[5].endvalue, -12.9248));
    ...
    assert(host_seq.values[2].f64 == 100);
    assert(host_seq.values[3].f64 == 1300);
    assert(host_seq.values[4].f64 == 5000);
    // Global Values
    assert(host_seq.values[5].i64 == 100);
    assert(host_seq.values[6].i64 == 1400);
    assert(host_seq.values[7].i64 == 6400);
    // Channels
    assert(approx(host_seq.values[8].f64, -2.6648));
    // Measures
    assert(approx(host_seq.values[9].f64, -0.52));
    assert(host_seq.values[10].f64 == -0.4);
    assert(approx(host_seq.values[11].f64, 0.48));
    assert(approx(host_seq.values[12].f64, 0.48));
    assert(approx(host_seq.values[13].f64, 3.0352));
    assert(approx(host_seq.values[14].f64, 1.084));
    // Need Orders
    // V15 is a ramp
    assert(approx(host_seq.values[16].f64, -0.52));
    assert(approx(host_seq.values[17].f64, 1.084));
    assert(host_seq.values[18].i64 == 6956);
    assert(approx(host_seq.values[19].f64, -2.6648));
    assert(approx(host_seq.values[20].f64, 3.0352));
    ...
    assert(host_bseq->pulses[3].chn == 1);
    assert(approx(host_bseq->pulses[3].endvalue, 1.084));
    assert(host_bseq->pulses[4].id == 6);
    assert(host_bseq->pulses[4].chn == 1);
    assert(approx(host_bseq->pulses[4].endvalue, 3.0352));
    assert(host_bseq->pulses[5].id == 5);
    assert(host_bseq->pulses[5].chn == 1);
    assert(approx(host_bseq->pulses[5].endvalue, -2.6648));
    ...
    // Slots
    assert(host_seq.values[2].f64 == 100);
    assert(host_seq.values[3].f64 == 700);
    assert(host_seq.values[4].f64 == 4244);
    // Global Values
    assert(host_seq.values[5].i64 == 100);
    assert(host_seq.values[6].i64 == 800);
    assert(host_seq.values[7].i64 == 5800);
    // Channels
    assert(approx(host_seq.values[8].f64, -12.9248));
    // Measures
    assert(approx(host_seq.values[9].f64, -0.52));
    assert(host_seq.values[10].f64 == -0.4);
    assert(approx(host_seq.values[11].f64, 0.08));
    assert(approx(host_seq.values[12].f64, 0.48));
    assert(approx(host_seq.values[13].f64, 1.084));
    assert(approx(host_seq.values[14].f64, -4.616));
    // Need Orders
    ...
    assert(approx(host_seq.values[16].f64, -0.52));
    assert(approx(host_seq.values[17].f64, 1.084));
    assert(host_seq.values[18].i64 == 5800);
    assert(approx(host_seq.values[19].f64, -4.616));
    assert(approx(host_seq.values[20].f64, -12.9248));
    ...
    assert(host_seq.values[1].f64 == 1000);
    // Slots
    assert(host_seq.values[2].f64 == 300);
    assert(host_seq.values[3].f64 == 700);
    assert(host_seq.values[4].f64 == 3529);
    // Global Values
    assert(host_seq.values[5].i64 == 300);
    assert(host_seq.values[6].i64 == 1000);
    assert(host_seq.values[7].i64 == 6000);
    // Channels
    assert(approx(host_seq.values[8].f64, -1.9928));
    // Measures
    assert(host_seq.values[9].f64 == -0.4);
    assert(approx(host_seq.values[10].f64, 0.6));
    assert(approx(host_seq.values[11].f64, 0.78));
    assert(approx(host_seq.values[12].f64, 0.78));
    assert(approx(host_seq.values[13].f64, 3.7072));
    assert(approx(host_seq.values[14].f64, 1.324));
    // Need Orders
    // V15 is a ramp
    assert(approx(host_seq.values[16].f64, 0.78));
    assert(approx(host_seq.values[17].f64, 1.324));
    assert(host_seq.values[18].i64 == 6001);
    assert(approx(host_seq.values[19].f64, -1.9928));
    assert(approx(host_seq.values[20].f64, 3.7072));

    assert(host_bseq->pulses.size() == 6);
    assert(host_bseq->pulses[0].id == 1);
    assert(host_bseq->pulses[0].chn == 1);
    assert(approx(host_bseq->pulses[0].endvalue, 0.6));
    assert(host_bseq->pulses[1].id == 2);
    assert(host_bseq->pulses[1].chn == 1);
    assert(approx(host_bseq->pulses[1].endvalue, 0.78));
    assert(host_bseq->pulses[2].id == 3); // measure
    assert(host_bseq->pulses[2].chn == 1);
    assert(host_bseq->pulses[2].len == uint32_t(-2));
    assert(host_bseq->pulses[3].id == 4);
    assert(host_bseq->pulses[3].chn == 1);
    assert(approx(host_bseq->pulses[3].endvalue, 1.324));
    assert(host_bseq->pulses[4].id == 6);
    assert(host_bseq->pulses[4].chn == 1);
    assert(approx(host_bseq->pulses[4].endvalue, 3.7072));
    assert(host_bseq->pulses[5].id == 5);
    assert(host_bseq->pulses[5].chn == 1);
    assert(approx(host_bseq->pulses[5].endvalue, -1.9928));
    ...
    assert(host_seq.values[1].f64 == 1000);
    // Slots
    assert(host_seq.values[2].f64 == 1300);
    assert(host_seq.values[3].f64 == 700);
    assert(host_seq.values[4].f64 == 4528);
    // Global Values
    assert(host_seq.values[5].i64 == 1300);
    assert(host_seq.values[6].i64 == 2000);
    assert(host_seq.values[7].i64 == 7000);
    // Channels
    assert(approx(host_seq.values[8].f64, -12.2528));
    // Measures
    assert(host_seq.values[9].f64 == -0.4);
    assert(approx(host_seq.values[10].f64, 0.6));
    assert(approx(host_seq.values[11].f64, 0.78));
    assert(approx(host_seq.values[12].f64, 0.78));
    assert(approx(host_seq.values[13].f64, 1.324));
    assert(approx(host_seq.values[14].f64, -4.376));
    // Need Orders
    // V15 is a ramp
    assert(approx(host_seq.values[16].f64, 0.78));
    assert(approx(host_seq.values[17].f64, 1.324));
    assert(host_seq.values[18].i64 == 7000);
    assert(approx(host_seq.values[19].f64, -4.376));
    assert(approx(host_seq.values[20].f64, -12.2528));
    ...
    assert(host_bseq->pulses[4].id == 5);
    assert(host_bseq->pulses[4].chn == 1);
    assert(approx(host_bseq->pulses[4].endvalue, -4.376));
    assert(host_bseq->pulses[5].id == 6);
    assert(host_bseq->pulses[5].chn == 1);
    assert(approx(host_bseq->pulses[5].endvalue, -12.2528));
...
int main()
{
    test_default_empty();
    test_increment_loop();
    test_increment_loop_t0();
    test_global();
    test_neg_endtime();
    test_need_order_assign();
    test_measure_order_id();
    test_ramp_measure();
